...
function setup() {
  ...
  // Get references to input range elements
  attackInput = document.getElementById("attack");
  decayInput = document.getElementById("decay");
  sustainInput = document.getElementById("sustain");
  releaseInput = document.getElementById("release");

  // Create main gain node and connect it to the audio context destination
  ...
  envelope.gain.value = 0; // Initial gain value
...
function playTone(freq) {
  ...
  osc.stop(audioContext.currentTime + attack + decay + release);
